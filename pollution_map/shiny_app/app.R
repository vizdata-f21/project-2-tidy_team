  ...
  sidebarLayout(
    ...
    sidebarPanel(
      selectInput("air_pollution_type", h4("Type of Air pollution"), choices
                  =list("Ambient Particular Matter","Household Solid Fuels","Ambient Ozone", "Total"), selected = "Ambient Particular Matter"),
      selectInput("other_risk_factors", h4("Other Risk Factors"),
                  choices = list("Unsafe water Source", "Unsafe Sanitation",
                                 "NO Access to hand wash","Non exclusive breast feeding"), selected = "Unsafe water Source")),
