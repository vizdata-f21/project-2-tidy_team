...
Next Steps: 
1. Finish fixing inconsistencies [prior to Wed meeting]
2. decide if we like aesthetics [prior to Wed meeting]
...
# Next Step: Do a series of case_when (before join) to resolve inconsistencies 
  # noticible ones include: Cote d'ivorie, Congo, Dem. Rep of COngo, Czechnia, French Guiana
