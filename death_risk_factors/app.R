        ...
        mainPanel(
          fluidPage(
            verticalLayout(
              ...
              bsTooltip(
                id = "plot_air_pollution_line", title = "The figure is a line chart titled \\'Number of Deaths from Selected Air Pollution Type by Region\\' that displays the raw number of death due to the selected air pollution type by region of the world over time. The three possible types of air pollution that can be selected are \\’Outdoor Air Pollution,\\’ \\'Household Air Pollution from Solid Fuels,\\' and \\’Air Pollution (Total).\\’ The range of years is every year from 1990 to 2017. The user can select up to 3 regions, each of which is its own line, to compare from, including \\'Central Asia,\\' \\'Central Europe,\\' \\'Central Latin America,\\' \\'Central Sub-Saharan Africa,\\' \\'Eastern Europe,\\' \\'Eastern Sub-Saharan Africa,\\' \\'Latin America and Caribbean,\\' \\'North Africa and Middle East,\\' \\'North America,\\' \\'South Asia,\\' \\'Southeast Asia,\\' \\'Southern Latin America,\\' \\'Southern Sub-Saharan Africa,\\' \\'Sub-Saharan Africa,\\' \\'Tropical Latin America,\\' \\'Western Europe,\\' and \\'Western Sub-Saharan Africa.\\'",
                placement = "bottom",
                trigger = "hover",
                options = NULL
              ),
